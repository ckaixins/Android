                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (strUserName.length() > 10) {
                            Toast.makeText(SignUpActivity.this, "太长啦！", Toast.LENGTH_SHORT).show();
                        } else if (strUserName.length() < 4) {
                            Toast.makeText(SignUpActivity.this, "太短啦！", Toast.LENGTH_SHORT).show();
                        } else if (strPassWord.length() > 16) {
                            Toast.makeText(SignUpActivity.this, "太复杂啦！！", Toast.LENGTH_SHORT).show();
                        } else if (strPassWord.length() < 6) {
                            Toast.makeText(SignUpActivity.this, "太简单啦！！", Toast.LENGTH_SHORT).show();
                        } else if (!strPassWord.equals(strPassWordAgain)) {
                            Toast.makeText(SignUpActivity.this, "不一样哦！", Toast.LENGTH_SHORT).show();
